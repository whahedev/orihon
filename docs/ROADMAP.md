...
- `toGeoJSON()` round-trips Point / LineString / Polygon / rectangle-as-polygon / circle-as-polygon (sampled) or Circle properties (`radius` in meters on `properties.radius`).
